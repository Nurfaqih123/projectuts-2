...
<html lang="en">
    <head>
        ...
        <title>ATK Shop| Edit Order</title>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 fw-bold">Edit Order</h1>
                            <ol class="breadcrumb mb-4">
                                ...
                                <li class="breadcrumb-item"><a href="list_product.php">Orders</a></li>
                            ...
                            <div class="card-body">
                                <form method="POST" action="../../process/orders/proses_order.php" >
                                    ...
                                    <div class="form-control-sm">
                                        <label for="id" class="col-form-label">ID Pemesanan</label>
                                        <input type="text" name="id" class="form-control" id="id" value="<?=$result['id']?>">
                                    </div>
                                    <div class="form-control-sm">
                                        <label for="tanggal" class="col-form-label">Tanggal</label>
                                        <input type="text" name="tanggal" class="form-control" id="tanggal" value="<?=$result['tanggal']?>">
                                    </div>
                                    <div class="form-control-sm">
                                        <label for="produk_id" class="col-form-label">ID Produk</label>
                                        <input type="text" name="produk_id" class="form-control" id="produk_id" value="<?=$result['produk_id']?>">
                                    </div>
                                    <div class="form-control-sm">
                                        <label for="quantity" class="col-form-label">Quantity</label>
                                        <input type="text" name="quantity" class="form-control" id="quantity" value="<?=$result['quantity']?>">
                                    </div>
