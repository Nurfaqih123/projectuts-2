...
<html lang="en">
    <head>
        ...
        <title>ATK Shop | Create Brand</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 fw-bold">Create Brand</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <form method="POST" action="../../process/brands/proses_brand.php">
                                <div class="form-control-sm">
                                    ...
                                    <input type="text" name="nama_merk" class="form-control" id="nama_merk" placeholder="Nama Brand" required="">
                                </div>
