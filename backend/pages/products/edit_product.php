...
<html lang="en">
    <head>
        ...
        <title>ATK Shop | Edit Product</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 fw-bold">Edit Product</h1>
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="dashboard/dashboard_product.php">Dashboard</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="POST" action="../../process/products/proses_product.php" >
                                    ...
                                    <div class="form-control-sm">
                                        <label for="id" class="col-form-label">ID Produk</label>
                                        <input type="number" name="id" class="form-control" id="id" value="<?=$result['id']?>">
                                    </div>
                                    <div class="form-control-sm">
                                        <label for="stok" class="col-form-label">Stok</label>
                                        <input type="text" name="stok" class="form-control" id="stok" value="<?=$result['stok']?>">
                                    </div>
                                    <div class="form-control-sm">
                                        <label for="harga" class="col-form-label">Harga</label>
                                        <input type="text" name="harga"class="form-control" id="harga" value="<?=$result['harga']?>">
                                    </div>
                                    <div class="form-control-sm">
                                        <label for="merk_id" class="col-form-label">ID Merk</label>
                                        <input type="text" name="merk_id" class="form-control" id="merk_id" value="<?=$result['merk_id']?>">
                                    </div>
                                    <div class="form-control-sm mt-3">
                                        <input type="submit" name="proses" class="btn btn-outline-primary btn-sm" value="Update">
                                    </div>
                                </form>
                            </div>
                        </div>
