...
<html lang="en">
    <head>
        ...
        <title>ATK Shop| Create Product</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 fw-bold">Create Product</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <form method="POST" action="../../process/products/proses_product.php">
                                ...
                                <div class="form-control-sm">
                                    ...
                                    <input type="number" name="stok" class="form-control" id="stok" placeholder="Jumlah Stok" required="">
                                </div>
                                <div class="form-control-sm">
                                    <label for="harga" class="col-form-label">Harga</label>
                                    <input type="number" name="harga"class="form-control" id="harga" placeholder="Nominal Harga" required="">
                                </div>
                                <div class="form-control-sm">
                                    <label for="merk_id" class="col-form-label">ID Merk</label>
                                    <input type="text" name="merk_id" class="form-control" id="merk_id" placeholder="Nama Merk" required="">
                                </div>    
                                <div class="form-control-sm mt-3">
                                    <input type="submit" name="proses" class="btn btn-outline-primary btn-sm" value="Simpan">
                                </div>
                            </form>
                            </div>
                        </div>
