...
<html lang="en">
    <head>
        ...
        <title>ATK Shop | List Product</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <a href="create_product.php" class="btn btn-outline-secondary btn-sm">
                                        Create New Product
                                    </a>
                                </div>
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$row['merk_id']?></td>
                                            <td>
                                                <a class="btn btn-outline-success btn-sm" href="view_product.php?id=<?=$row['id']?>">View</a>
                                                <a class="btn btn-outline-warning btn-sm" href="edit_product.php?idedit=<?=$row['id']?>">Edit</a>
                                                <a class="btn btn-outline-danger btn-sm" href="../../process/products/delete_product.php?iddel=<?=$row['id']?>"
                                                onclick="if(!confirm('Anda Yakin Ingin Menghapus Produk <?=$row['nama']?>?')) {return false}">Delete</a>
                                            </td>
                                        </tr>
                                        <?php
                                        $nomor++;
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-black">Copyright &copy; STT Nurul Fikri ATK Shop2023</div>
                            <div>
                                <a href="#">Privacy</a>
                                &middot;
